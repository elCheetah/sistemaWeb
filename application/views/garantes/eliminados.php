        ...
        <div class="row page-titles mx-0 ">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Garantes - Eliminados</h4>
                    <p class="mb-0">Lista de Garantes Inactivos</p>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?= site_url('garantes/index') ?>">Activos</a>
                    </li>
                </ol>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($garantes as $garante): ?>
                                        <tr>
                                            ...
                                            <td><?= $garante['nombre'] . ' ' . $garante['primer_apellido'] . ' ' . $garante['segundo_apellido'] ?>
                                            </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="<?= site_url('garantes/habilitar/' . $garante['garante_id']) ?>">Habilitar</a>
                                                        <a class="dropdown-item"
                                                            href="<?= site_url('garantes/eliminar/' . $garante['garante_id']) ?>"
