                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="<?= base_url('index.php/clientes/agregar') ?>" enctype="multipart/form-data">
                                <h4 class="text-primary mb-4">Información Personal</h4>

                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="ci" class="text-black">Cédula de Identidad (CI)</label>
                                        <input type="text" class="form-control" id="ci" name="ci" placeholder="Cédula de Identidad" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="basic-form">
                                            <div class="form-group mb-0">
                                                <label class="radio-inline mr-3"><input type="radio" name="genero" value="Masculino" required> Masculino</label>
                                                <label class="radio-inline mr-3"><input type="radio" name="genero" value="Femenino" required> Femenino</label>
                                                <label class="radio-inline mr-3"><input type="radio" name="genero" value="Otro" required> Otro</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="telefono" name="telefono" placeholder="1234-5678" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="text-black" for="promedio_ingresos_mensuales">Promedio de Ingresos Mensuales</label>
                                        <input type="text" class="form-control" id="promedio_ingresos_mensuales" name="promedio_ingresos_mensuales" placeholder="Ingresos Mensuales" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label class="text-black" for="direccion_ocupacion">Dirección del Trabajo</label>
                                        <input type="text" class="form-control" id="direccion_ocupacion" name="direccion_ocupacion" placeholder="Dirección del Trabajo" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="select2-with-label-single js-states d-block" id="primer_garante_id" name="primer_garante_id" required>
                                            <option value="">Seleccionar Garante</option>
                                            <!-- Aquí deben agregarse las opciones dinámicamente según la base de datos -->
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="text-black" for="segundo_garante_id">Segundo Garante</label>
                                        <select class="select2-with-label-single js-states d-block" id="segundo_garante_id" name="segundo_garante_id">
                                            <option value="">Seleccionar Garante</option>
                                            <!-- Aquí deben agregarse las opciones dinámicamente según la base de datos -->
                                        </select>
                                    </div>
