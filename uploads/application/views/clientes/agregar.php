                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="<?= base_url('index.php/clientes/agregar') ?>"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="basic-form">
                                            <div class="form-group mb-0">
                                                ...
                                                <label class="radio-inline mr-3"><input type="radio" name="genero"
                                                        value="Femenino" required> Femenino</label>
                                                <label class="radio-inline mr-3"><input type="radio" name="genero"
                                                        value="Otro" required> Otro</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="text-black" for="promedio_ingresos_mensuales">Promedio de Ingresos
                                            Mensuales</label>
                                        <input type="text" class="form-control" id="promedio_ingresos_mensuales"
                                            name="promedio_ingresos_mensuales" placeholder="Ingresos Mensuales"
                                            required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label class="text-black" for="direccion_ocupacion">Dirección del
                                            Trabajo</label>
                                        <input type="text" class="form-control" id="direccion_ocupacion"
                                            name="direccion_ocupacion" placeholder="Dirección del Trabajo" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="select2-with-label-single js-states d-block"
                                            id="primer_garante_id" name="primer_garante_id" required>
                                            <option value="">Seleccionar Garante</option>
                                            <?php foreach ($garantes as $garante): ?>
                                                <option value="<?= $garante['garante_id']; ?>">
                                                    <?= $garante['nombre'] . ' ' . $garante['primer_apellido'] . ' ' . $garante['segundo_apellido']; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
