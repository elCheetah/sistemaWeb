                        ...
                        <div class="basic-form">
                            <form method="post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control select2-with-label-single js-states d-block"
                                            ...
                                            <?= $cliente['garante_nombre'] . ' ' . $cliente['garante_primer_apellido'] . ' ' . $cliente['garante_segundo_apellido']; ?>
                                            </option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control select2-with-label-single js-states d-block"
                                            ...
                                            <option value="<?= $cliente['segundo_garante_id'] ?>">
                                                <?= $cliente['segundo_garante_nombre'] . ' ' . $cliente['segundo_garante_primer_apellido'] . ' ' . $cliente['segundo_garante_segundo_apellido']; ?>
                                            </option>
                                            <?php foreach ($garantes as $garante): ?>
                                                <option value="<?= $garante['garante_id'] ?>">
                                                    <?= $garante['nombre'] . ' ' . $garante['primer_apellido'] . ' ' . $garante['segundo_apellido']; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?= base_url('index.php/clientes') ?>" class="btn btn-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div>
                    </div>
