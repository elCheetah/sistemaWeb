...
class Clientes extends CI_Controller
{
    ...
    public function agregar()
    {
        if ($this->input->post()) {
            ...
            // Obtener los garantes activos
            $data['garantes'] = $this->Garante_model->obtener_garantes_activos();

            // Cargar la vista de agregar cliente
            $this->load->view('templates/header');
            $this->load->view('templates/navbar');
            $this->load->view('templates/sidebar');
            $this->load->view('clientes/agregar', $data); // Pasar los datos de garantes a la vista
            $this->load->view('templates/footer');
        }
    }
